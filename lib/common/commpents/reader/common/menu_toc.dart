              ...
              Obx(() => Row(
                      children: [
                        TextButton(
                            onPressed: () {
                              ReaderThemeC
                                  .current.tocButtonsCurrentIndex.value = 0;
                              ReaderThemeC.current.tocPageController
                                  .jumpToPage(0);
                            },
                            child: Text(
                              "目录",
                        ...
                        TextButton(
                            onPressed: () {
                              ReaderThemeC
                                  .current.tocButtonsCurrentIndex.value = 1;
                              ReaderThemeC.current.tocPageController
                                  .jumpToPage(1);
              ...
              Expanded(
                ...
                children: [
                  ListView.separated(
                            ...
                            controller:
                                ReaderThemeC.current.tocScrollController,
                            cacheExtent: 46,
                            itemBuilder: (context, index) {
                              if (index == 0) {
                                ...
                                return InkWell(
                                    onTap: () {
                                      FloatController.current.onToc.value =
                                          true;
                                        ...
                                        () => Text(
                                          ...
                                          style: TextStyle(
                                              color: ReaderThemeC.current
                                                          .currentindex.value ==
                                                      (index - 1)
                                                  ? ReaderThemeC.current.theme
                                                      .value.primaryColor
                                                  : ReaderThemeC.current.theme
                                                      .value.pannelTextColor,
                                              fontSize: 13),
                                        ),
                                      ),
                                    ));
                            ...
                            separatorBuilder:
                              ...
                              return Divider(
                                ...
                                thickness: 0.4,
                                color: ReaderThemeC
                                    .current.theme.value.dividerColor,
                              );
                            },
...
''');
                ...
                title: Text("划线：${text1[index].length>30?text1[index].substring(0,29):text1[index]}",maxLines: 1,style: TextStyle(color: Color(int.parse("0xff${color[index].toString().substring(1)}"))),),
                trailing: Text(note[index]=="空_"?"":"笔记：${note[index].length>30?note[index].substring(0,29):note[index]}",maxLines: 1,style: TextStyle(color: Color(int.parse("0xff${color[index].toString().substring(1)}"))),),
                      ),
                    ) ,
                   );
                 },)
