            ...
            child: Row(
              children: [
                ...
                Stack(
                  children: [
                    index == currentindex
                        ? Image.asset("assets/img/$value.png")
                        : Image.asset("assets/img/${value}_normal.png"),
                    // ignore: unrelated_type_equality_checks
                    index == 1
                        ? Obx(() => LeftBarCtr.current.subint == 0
                            ? Container()
                            : Text(
                                LeftBarCtr.current.subint.value.toString(),
                                style:
                                    const TextStyle(color: Color(0xffFFC54F)),
                              ))
                        : Container()
                  ],
                ),
